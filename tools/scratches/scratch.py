...
colors = colors.split()
filtered_colors = [color for color in colors if not color.casefold().startswith('gray') and not color.casefold().startswith('grey')]
filtered_colors = sorted(filtered_colors)
from antipetros_discordbot.utility.gidtools_functions import writejson
writejson(filtered_colors, r"D:\Dropbox\hobby\Modding\Programs\Github\My_Repos\Antipetros_Discord_Bot_new\docs\resources\data/graphviz_colors.json")
